...
export default function PLLPage() {
  ...
  const pllCases = [
    ...
    { id: "pll_Ga", name: "Ga", algorithm: "(UD' R2 U) (R' U R' U' R U') (R2 U'D R' U R)", steps: [t("Ga перестановка"), t("Завершить выравнивание")] },
    { id: "pll_Gb", name: "Gb", algorithm: "(R' U' R UD') (R2 U R' U) (R U' R U') R2 U'D", steps: [t("Gb перестановка"), t("Завершить выравнивание")] },
    { id: "pll_Gc", name: "Gc", algorithm: "R2 F2 (R U2) (R U2) R' F (R U R' U') R' F R2 ", steps: [t("Gc перестановка"), t("Завершить выравнивание")] },
    { id: "pll_Gd", name: "Gd", algorithm: "(R U R' U'D) (R2 U' R U') (R' U R' U) R2 UD'", steps: [t("Gd перестановка"), t("Завершить выравнивание")] },
    { id: "pll_H", name: "H", algorithm: "(M2 U) (M2 U) (M2 U) (M2 U) (M2 U) (M2 U)", steps: [t("Поменять противоположные ребра"), t("Достроить слой")] },
    { id: "pll_Ja", name: "Ja", algorithm: "U2 (L' U' L F) (L' U' L U) (L F' L2 U L) U'", steps: [t("Ja перестановка"), t("Фиксируем")] },
    { id: "pll_Jb", name: "Jb", algorithm: "R U R' F' R U R' U' R' F R2 U' R' U'", steps: [t("Jb перестановка"), t("Фиксируем")] },
    { id: "pll_Na", name: "Na", algorithm: "(R U R' U) (R U R' F') (R U R' U') (R' F R2 U') R' U2 (R U' R')", steps: [t("Na перестановка"), t("Фиксируем")] },
    { id: "pll_Nb", name: "Nb", algorithm: "(R' U R U') (R' F' U' F) (R U R' F) R' F' (R U' R)", steps: [t("Nb перестановка"), t("Фиксируем")] },
    { id: "pll_Ra", name: "Ra", algorithm: "(R U R' F') (R U2 R' U2) R' F (R U R) U2 R' U'", steps: [t("Ra ребра + углы"), t("Фиксируем")] },
    ...
    { id: "pll_V", name: "V", algorithm: "(R U2 R' D) (R U' R U' R U R2 D) (R' U' R D2)", steps: [t("V перестановка"), t("Фиксируем")] },
