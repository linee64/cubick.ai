...
const enDict: Record<string, string> = {
  ...
  "Практика с AI‑Coach": "Practice with AI Coach",
...
// Features
  ...
  "Найдите ребро без жёлтой наклейки на верхнем слое.": "Find an edge without yellow sticker on the top layer.",
  "Совместите лицевой цвет ребра с центром передней грани.": "Match the edge's front color with the front center.",
  "Если целевой цвет справа: поверните верхний слой от цвета на один ход.": "If target color is on the right: turn U away by one move.",
  "Выполните правый пиф‑паф: R U R' U'.": "Do right sexy move: R U R' U'.",
  "Перехват к целевому цвету и левый пиф‑паф: L' U' L U.": "Regrip to target color and do left sexy: L' U' L U.",
  "Если целевой цвет слева: зеркально — повернуть от цвета, левый пиф‑паф, перехват, правый пиф‑паф.": "If target is left: mirror — turn away, left sexy, regrip, right sexy.",
  "Повторите для всех четырёх рёбер среднего слоя.": "Repeat for all four middle layer edges.",
  "Формальный алгоритм вправо:": "Formal right insert:",
  "Формальный алгоритм влево:": "Formal left insert:",
  ...
  "Среднее из 5": "Average of 5",
  "Среднее из 12": "Average of 12",
  "🔒 Требуется авторизация": "🔒 Authorization required",
  "Войдите, чтобы общаться с ИИ": "Sign in to chat with AI",

  // Motivational Quotes
  "Мотивация": "Motivation",
  "Скорость — это не главное, главное — стабильность.": "Speed is not the main thing, consistency is.",
  "Каждая сборка делает тебя лучше.": "Every solve makes you better.",
  "Не бойся ошибаться, бойся не пробовать.": "Don't be afraid to make mistakes, be afraid not to try.",
  "Чем медленнее ты тренируешься, тем быстрее ты собираешь.": "Slow is smooth, smooth is fast.",
  "Кубик Рубика — это марафон, а не спринт.": "Rubik's cube is a marathon, not a sprint.",
  "Терпение и труд все перетрут.": "Patience and hard work grind everything down.",
  "Секрет успеха — в регулярности тренировок.": "The secret of success is in the regularity of training.",
  "Анализируй свои ошибки, чтобы не повторять их.": "Analyze your mistakes so as not to repeat them.",
  "⏳ Слишком часто": "⏳ Too frequent",
  "Подождите": "Please wait",
  "перед следующим запросом": "before the next request",
  "🚫 Тема вне спидкубинга": "🚫 Topic outside speedcubing",
  "Я отвечаю только по вопросам спидкубинга. Переформулируйте запрос.": "I answer speedcubing questions only. Please rephrase.",
  "⚠️ Ошибка": "⚠️ Error",
  "⏱️ Истек таймаут запроса": "⏱️ Request timed out",
  "🌐 Сетевая ошибка": "🌐 Network error",
  "🚦 Лимит запросов": "🚦 Rate limit",
  "Сервис перегружен. Попробуйте снова через 10–30 сек": "Service overloaded. Try again in 10–30 sec",
  "Слишком много запросов, попробуйте позже": "Too many requests, please try later",
  ...
  // OLL steps
  "Распознать форму": "Recognize shape",
  "Выполнить алгоритм ориентации": "Execute orientation algorithm",
  "Выполнить алгоритм": "Execute algorithm",
  "Распознать": "Recognize",
  "Алгоритм": "Algorithm",

  // PLL steps
  "Переставить углы типа A": "Permute A-type corners",
  "Сохранить ребра": "Keep edges",
  "Переставить углы типа A (зерк.)": "Permute A-type corners (mirror)",
  "Меняем диагональные углы": "Swap diagonal corners",
  "Сохраняем ребра": "Keep edges",
  "Меняем два угла и два ребра": "Swap two corners and two edges",
  "Фиксируем слой": "Fix the layer",
  "Ga перестановка": "Ga permutation",
  "Gb перестановка": "Gb permutation",
  "Gc перестановка": "Gc permutation",
  "Gd перестановка": "Gd permutation",
  "Завершить выравнивание": "Finish alignment",
  "Ja перестановка": "Ja permutation",
  "Фиксируем": "Finalize",
  "Jb перестановка": "Jb permutation",
  "Na перестановка": "Na permutation",
  "Nb перестановка": "Nb permutation",
  "Ra ребра + углы": "Ra edges + corners",
  "Rb ребра + углы": "Rb edges + corners",
  "T перестановка": "T permutation",
  "Сдвиг ребер по часовой": "Shift edges clockwise",
  "Сохранить углы": "Keep corners",
  "Сдвиг ребер против часовой": "Shift edges counterclockwise",
